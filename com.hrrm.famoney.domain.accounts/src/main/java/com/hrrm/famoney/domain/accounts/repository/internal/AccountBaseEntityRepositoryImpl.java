...
public class AccountBaseEntityRepositoryImpl extends AccountBaseJpaRepositoryImpl<AccountBaseEntity>
        implements AccountBaseEntityRepository<AccountBaseEntity> {
