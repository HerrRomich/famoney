...
import com.hrrm.famoney.domain.masterdata.IncomeCategory;
import com.hrrm.famoney.domain.masterdata.IncomeCategory_;
...
public class IncomeCategoryRepositoryImpl extends EntryCategoryRepositoryImpl<IncomeCategory> implements
    ...
    public IncomeCategoryRepositoryImpl(@Reference LoggerFactory loggerFactory, @Reference TransactionControl txControl,
            @Reference(target = "(name=master-data)") JPAEntityManagerProvider entityManagerProvider) {
        super(loggerFactory,
            txControl,
