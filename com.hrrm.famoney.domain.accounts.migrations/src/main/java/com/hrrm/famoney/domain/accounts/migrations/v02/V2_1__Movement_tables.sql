create or replace table movement(
  ...
  pos int not null comment 'Position of movement relative to account.',
  booking_date date comment 'Date of booking. Could be null, then equals to date of movement',
  ...
  constraint unique movement_account_pos_uq (account_id, pos),
...
create or replace table entry_item(
  ...
  pos int not null comment 'Position of entry item relative to movement.',
