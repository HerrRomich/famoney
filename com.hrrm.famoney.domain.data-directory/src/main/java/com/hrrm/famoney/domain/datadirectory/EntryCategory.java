...
@Entity
@Table(schema = DataDirectoryDomainEntity.SCHEMA_NAME, name = "entry_category")
...
public abstract class EntryCategory<T extends EntryCategory<T>> extends DataDirectoryDomainEntity {
