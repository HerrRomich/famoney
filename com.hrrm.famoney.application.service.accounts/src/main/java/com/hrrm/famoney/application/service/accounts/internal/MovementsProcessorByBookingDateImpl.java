...
@Component(name = "MovementsProcessorByBookingDate", service = MovementsProcesor.class)
public class MovementsProcessorByBookingDateImpl extends MovementsProcessorImpl implements MovementsProcesor {

    private final MovementSliceRepository movementSliceRepository;
    private final MovementRepository movementRepository;

    @Activate
    public MovementsProcessorByBookingDateImpl(@Reference final TransactionControl txControl,
    ...
    protected Optional<MovementSlice> findLastByAccountBeforeOffsetByDate(final Integer accountId,
        ...
        return movementSliceRepository.findLastByAccountBeforeOffsetByBookingDate(accountId,
                offset);
    }
    ...
    protected List<Movement> findMovementsByAccountIdAfterDate(final Integer accountId, final LocalDateTime dateFrom,
        ...
        return movementRepository.findMovementsByAccountIdAfterBookingDate(accountId,
                dateFrom,
    ...
    protected Integer getCount(final MovementSlice movementSlice) {
        return movementSlice.getBookingCount();
    }

    @Override
    protected BigDecimal getSum(final MovementSlice movementSlice) {
        return movementSlice.getBookingSum();
    }
